...
void VulkanRenderer::RequestResize(uint32_t new_width, uint32_t new_height) {
    m_window_extent.width  = new_width;
    m_window_extent.height = new_height;
    m_context.resize_requested = true;
}
