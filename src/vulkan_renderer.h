...
#include "platform/platform_select.h"
...
struct RendererProperties {
    ...
    bool stop_at_max_iterations = true;

    bool continue_offscreen_if_minimized = false;
...
public:
    ...
    void RequestResize(uint32_t new_width, uint32_t new_height);
private:
